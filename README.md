...
Solar Surplus has eligibility criteria and is still being rolled out. ENGIE lists four requirements: solar panels that inject into the grid, a digital meter, an Easy, Flow, Empower or Direct electricity contract, and use of the ENGIE Smart App. On top of that, ENGIE states it is testing the feature with a small group before releasing it to everyone who meets those criteria. So if you have solar panels but no Solar Surplus entities, check the four requirements first, and if you meet all of them your account is most likely not in the rollout yet. See [engie.be/nl/solar-surplus](https://www.engie.be/nl/solar-surplus).

The Energy dashboard's solar forecast shows expected injection, not production. Home Assistant calls that card "Solar production forecast", but ENGIE only forecasts injection, which is what your panels generate minus what your household is using at that moment. The card therefore reads lower than your actual production by however much you consume on site, and it drops to zero for hours where you expect to consume everything you generate. This is the only solar figure ENGIE publishes.
